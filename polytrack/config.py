...
__PT.POLYTRACK.OUTPUT         = './data/output/'
...
__PT.POLYTRACK.SAVE_VIDEO_OUTPUT    = False
...
__PT.POLYTRACK.MAX_OCCLUSIONS = 60 #Threshold number of undetected frames (previously 60)
...
__PT.POLYTRACK.MAX_DIST_BS = 125 #previously 80 125
__PT.POLYTRACK.MAX_DIST_DL = 300 #previously 240 300
...
__PT.POLYTRACK.INSECT_VERIFICATION_MIN_BS = 0.5
...
__PT.POLYTRACK.MIN_INSECT_AREA = 2 #5
__PT.POLYTRACK.MAX_INSECT_AREA = 4750 #Previosuly 3750
...
__PT.POLYTRACK.DL_SCORE_THRESHOLD = 0.3 #0.5
__PT.POLYTRACK.DL_IOU_THRESHOLD = 0.3 # 0.5
